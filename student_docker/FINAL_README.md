...
```
Acc_f  0.0000    Acc_r  95.7259
CKA_f  0.00438   CKA_r  0.99640
AUS    0.99842   RUS_o  0.99605   final_score  0.99723
```

리더보드(private) 실측: **0.99634**
...
M_o (m_o/M_o.pt)
  ...
  ▼
models/ckar8m_s2200.pt ... models/ckar8m_s4600.pt   (13개)
  │
...
| `lambda_cka_r` 8.0 | retain | 미니배치 linear CKA 최대화 |
...
# ② 같은 궤적 스냅샷 13개 균등 평균
python tools/average_snapshots.py models/ckar8m_s*.pt --out models/averaged.pt
...
configs/final.yaml             ①에 사용한 config (원본: configs/ckar8m.yaml)
